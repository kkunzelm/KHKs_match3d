...
public class SimpleSTL_WriterVec3Based implements PlugInFilter {
	...
	private static List makeTriangleList(ImagePlus imp) {
	...
	private void write(DataOutputStream out) {
		...
		for (Object get : triangleList) {
			...
			pw.println("facet normal " + currentTriangle.getNormal().x + " " + currentTriangle.getNormal().y + " "
					+ currentTriangle.getNormal().z);
			pw.println("outer loop");
			// todo check: if scaleX and Y are different, then it could be that I have to
			// swap scaleX and scaleY here --- see comment line 260ff
			pw.println("vertex " + currentTriangle.getVertex0().x + " " + currentTriangle.getVertex0().y + " "
					+ currentTriangle.getVertex0().z);
			pw.println("vertex " + currentTriangle.getVertex1().x + " " + currentTriangle.getVertex1().y + " "
					+ currentTriangle.getVertex1().z);
			pw.println("vertex " + currentTriangle.getVertex2().x + " " + currentTriangle.getVertex2().y + " "
					+ currentTriangle.getVertex2().z);
			pw.println("endloop");
			pw.println("endfacet");
