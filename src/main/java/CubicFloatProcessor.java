...
public class CubicFloatProcessor extends FloatProcessor{
	double ll_ll = 0;
	double ll_l = 0;
	double ll_r = 0;
	double ll_rr = 0;
    ...
    public CubicFloatProcessor(int width, int height) {
        super(width, height);
        pixels = (float[])getPixels();
    }

    /** Creates a CubicFloatProcessor from an int array using the default grayscale LUT. */
    public CubicFloatProcessor(int width, int height, int[] pixelsInt) {
        super(width, height, pixelsInt);
        pixels = (float[])getPixels();
    }

    /** Creates a CubicFloatProcessor from a double array using the default grayscale LUT. */
    ...
    /** Creates a new CubicFloatProcessor containing a scaled copy of this image or selection. */
